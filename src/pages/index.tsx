  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Jobboard - Empowering the Indian Market with a Comprehensive Platform for Job Opportunities. Connect, Explore, and Secure Your Ideal Position Today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Jobboard - Empowering the Indian Market with a Comprehensive Platform for Job Opportunities. Connect, Explore, and Secure Your Ideal Position Today.`}
            </Text>
            <Box
